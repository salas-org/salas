...
node_cmd="$GOPATH/bin/geth --ipcpath $MINER_IPC_PATH --nat none --datadir $LOCAL_ETH_DATA_PATH --syncmode full --verbosity $VERBOSITY --port $LOCAL_PORT --networkid $NETWORKID"
